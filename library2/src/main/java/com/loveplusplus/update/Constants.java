...
class Constants {
    ...
    static final String UPDATE_URL ="http://192.168.5.26:51520/StaticFiles/update.json"; //"https://raw.githubusercontent.com/feicien/android-auto-update/develop/extras/update.json";
}
